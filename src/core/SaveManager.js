...
export class SaveManager {
 constructor(storage){this.error='';try{this.storage=storage===undefined?globalThis.localStorage:storage;}catch{this.storage=null;this.error='保存機能を使えないため、この冒険は保存されないよ。';}}
